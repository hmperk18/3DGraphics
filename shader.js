...
const U_SPOTLIGHT                        = "u_spotlight";
const U_SPOTLIGHT_DIR                    = "u_spotlightDir";
const U_SPOTLIGHT_COLOR                  = "u_spotlightColor";
const U_SPOTLIGHT2                        = "u_spotlight2";
const U_SPOTLIGHT_DIR2                    = "u_spotlightDir2";
const U_SPOTLIGHT_COLOR2                  = "u_spotlightColor2";
const U_SPOTLIGHT_LIMIT                  = "u_limit";
...
class Shader{
    ...
    static getStandardUniformLocations(gl, program){
        return {
            ...
            spotlight_dir:    gl.getUniformLocation(program, U_SPOTLIGHT_DIR),
            spotlight_color:  gl.getUniformLocation(program, U_SPOTLIGHT_COLOR),
            spotlight2:        gl.getUniformLocation(program, U_SPOTLIGHT2),
            spotlight_dir2:    gl.getUniformLocation(program, U_SPOTLIGHT_DIR2),
            spotlight_color2:  gl.getUniformLocation(program, U_SPOTLIGHT_COLOR2),
            spotlight_limit:  gl.getUniformLocation(program, U_SPOTLIGHT_LIMIT),
