...
class Matrix4x4{
    ...
    */
    static inverseTranspose3x3(m, out) {
        ...
        let m00 = m_r[ 0], m10 = m_r[ 4], m20 = m_r[ 8], m30 = m_r[12];
        let m01 = m_r[ 1], m11 = m_r[ 5], m21 = m_r[ 9], m31 = m_r[13];
        let m02 = m_r[ 2], m12 = m_r[ 6], m22 = m_r[10], m32 = m_r[14];
        let m03 = m_r[ 3], m13 = m_r[ 7], m23 = m_r[11], m33 = m_r[15];
        ...
        o_r[1] = (m12 * b08 - m10 * b11 - m13 * b07) * det;
        o_r[2] = (m10 * b10 - m11 * b08 + m13 * b06) * det;

        o_r[3] = (m02 * b10 - m01 * b11 - m03 * b09) * det;
        o_r[4] = (m00 * b11 - m02 * b08 + m03 * b07) * det;
        o_r[5] = (m01 * b08 - m00 * b10 - m03 * b06) * det;

        o_r[6] = (m31 * b05 - m32 * b04 + m33 * b03) * det;
        o_r[7] = (m32 * b02 - m30 * b05 - m33 * b01) * det;
    ...
    */
    static multV4(m, v, out) {
        ...
        let x = v.x,
            ...
            w = v.w;
        if(!out){
            v.x = m_r[0] * x + m_r[4] * y + m_r[ 8] * z + m_r[12] * w;
            v.y = m_r[1] * x + m_r[5] * y + m_r[ 9] * z + m_r[13] * w;
            v.z = m_r[2] * x + m_r[6] * y + m_r[10] * z + m_r[14] * w;
            v.w = m_r[3] * x + m_r[7] * y + m_r[11] * z + m_r[15] * w;
            return v;
        }
        out.x = m_r[0] * x + m_r[4] * y + m_r[ 8] * z + m_r[12] * w;
        out.y = m_r[1] * x + m_r[5] * y + m_r[ 9] * z + m_r[13] * w;
        out.z = m_r[2] * x + m_r[6] * y + m_r[10] * z + m_r[14] * w;
        out.w = m_r[3] * x + m_r[7] * y + m_r[11] * z + m_r[15] * w;
        return out;
    }
    ...
    */
    static multV3(m, v, out) {
        ...
        let x = v.x,
            ...
            z = v.z;
        if(!out){
            v.x = m_r[0] * x + m_r[4] * y + m_r[ 8] * z + m_r[12];
            v.y = m_r[1] * x + m_r[5] * y + m_r[ 9] * z + m_r[13];
            v.z = m_r[2] * x + m_r[6] * y + m_r[10] * z + m_r[14];
            return v;
        }
        out.x = m_r[0] * x + m_r[4] * y + m_r[ 8] * z + m_r[12];
        out.y = m_r[1] * x + m_r[5] * y + m_r[ 9] * z + m_r[13];
        out.z = m_r[2] * x + m_r[6] * y + m_r[10] * z + m_r[14];
        return out;
    }
    ...
    */
    static transformV3(m, v, out) {
        ...
        let x = v.x,
            ...
            z = v.z;
        if(!out){
            v.x = m_r[0] * x + m_r[4] * y + m_r[ 8] * z;
            v.y = m_r[1] * x + m_r[5] * y + m_r[ 9] * z;
            v.z = m_r[2] * x + m_r[6] * y + m_r[10] * z;
            return v;
        }
        out.x = m_r[0] * x + m_r[4] * y + m_r[ 8] * z;
        out.y = m_r[1] * x + m_r[5] * y + m_r[ 9] * z;
        out.z = m_r[2] * x + m_r[6] * y + m_r[10] * z;
        return out;
    }
    ...
    */
    static multM4(a, b, out){
        ...
        // a[column][row]
        let a00 = a_r[0], a10 = a_r[4], a20 = a_r[ 8], a30 = a_r[12],
            a01 = a_r[1], a11 = a_r[5], a21 = a_r[ 9], a31 = a_r[13],
            a02 = a_r[2], a12 = a_r[6], a22 = a_r[10], a32 = a_r[14],
            a03 = a_r[3], a13 = a_r[7], a23 = a_r[11], a33 = a_r[15];
        let b00 = b_r[0], b10 = b_r[4], b20 = b_r[ 8], b30 = b_r[12],
            b01 = b_r[1], b11 = b_r[5], b21 = b_r[ 9], b31 = b_r[13],
            b02 = b_r[2], b12 = b_r[6], b22 = b_r[10], b32 = b_r[14],
            b03 = b_r[3], b13 = b_r[7], b23 = b_r[11], b33 = b_r[15];

        o_r[0] = a00*b00 + a10*b01 + a20*b02 + a30*b03;
        o_r[1] = a01*b00 + a11*b01 + a21*b02 + a31*b03;
        o_r[2] = a02*b00 + a12*b01 + a22*b02 + a32*b03;
        o_r[3] = a03*b00 + a13*b01 + a23*b02 + a33*b03;

        o_r[4] = a00*b10 + a10*b11 + a20*b12 + a30*b13;
        o_r[5] = a01*b10 + a11*b11 + a21*b12 + a31*b13;
        o_r[6] = a02*b10 + a12*b11 + a22*b12 + a32*b13;
        o_r[7] = a03*b10 + a13*b11 + a23*b12 + a33*b13;

        o_r[ 8] = a00*b20 + a10*b21 + a20*b22 + a30*b23;
        o_r[ 9] = a01*b20 + a11*b21 + a21*b22 + a31*b23;
        o_r[10] = a02*b20 + a12*b21 + a22*b22 + a32*b23;
        o_r[11] = a03*b20 + a13*b21 + a23*b22 + a33*b23;

        o_r[12] = a00*b30 + a10*b31 + a20*b32 + a30*b33;
        o_r[13] = a01*b30 + a11*b31 + a21*b32 + a31*b33;
        o_r[14] = a02*b30 + a12*b31 + a22*b32 + a32*b33;
    ...
    */
    static applyRotationAxis(angle, axis, out){
        ...
        // a[column][row]
        let a00 = o_r[0], a10 = o_r[4], a20 = o_r[ 8], a30 = o_r[12],
            a01 = o_r[1], a11 = o_r[5], a21 = o_r[ 9], a31 = o_r[13],
            a02 = o_r[2], a12 = o_r[6], a22 = o_r[10], a32 = o_r[14],
            a03 = o_r[3], a13 = o_r[7], a23 = o_r[11], a33 = o_r[15];
    ...
    */
    static applyTranslation(x,y,z,out){
        ...
        let o_r = out.raw;
        o_r[12] = o_r[0] * x + o_r[4] * y + o_r[ 8] * z + o_r[12];
        o_r[13] = o_r[1] * x + o_r[5] * y + o_r[ 9] * z + o_r[13];
        o_r[14] = o_r[2] * x + o_r[6] * y + o_r[10] * z + o_r[14];
        o_r[15] = o_r[3] * x + o_r[7] * y + o_r[11] * z + o_r[15];
        return out;
    }
    ...
    */
    static invert(m, out) {
        ...
        let o_r = out.raw;
        let m_r = m.raw;
        var a00 = m_r[0], a10 = m_r[4], a20 = m_r[ 8], a30 = m_r[12],
            a01 = m_r[1], a11 = m_r[5], a21 = m_r[ 9], a31 = m_r[13],
            a02 = m_r[2], a12 = m_r[6], a22 = m_r[10], a32 = m_r[14],
            a03 = m_r[3], a13 = m_r[7], a23 = m_r[11], a33 = m_r[15],
        ...
        o_r[1] = (a02 * b10 - a01 * b11 - a03 * b09) * det;
        o_r[2] = (a31 * b05 - a32 * b04 + a33 * b03) * det;
        o_r[3] = (a22 * b04 - a21 * b05 - a23 * b03) * det;

        o_r[4] = (a12 * b08 - a10 * b11 - a13 * b07) * det;
        o_r[5] = (a00 * b11 - a02 * b08 + a03 * b07) * det;
        o_r[6] = (a32 * b02 - a30 * b05 - a33 * b01) * det;
        o_r[7] = (a20 * b05 - a22 * b02 + a23 * b01) * det;

        o_r[8] = (a10 * b10 - a11 * b08 + a13 * b06) * det;
        o_r[9] = (a01 * b08 - a00 * b10 - a03 * b06) * det;
        o_r[10] = (a30 * b04 - a31 * b02 + a33 * b00) * det;
        o_r[11] = (a21 * b02 - a20 * b04 - a23 * b00) * det;

        o_r[12] = (a11 * b07 - a10 * b09 - a12 * b06) * det;
        o_r[13] = (a00 * b09 - a01 * b07 + a02 * b06) * det;
        o_r[14] = (a31 * b01 - a30 * b03 - a32 * b00) * det;
